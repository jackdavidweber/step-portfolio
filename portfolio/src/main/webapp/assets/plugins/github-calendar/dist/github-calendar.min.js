            ...
            (p = m(p)),
              ((g = g || {}).summary_text =
                ...
                'Summary of pull requests, issues opened, and commits made by <a href="https://github.com/' +
                  ...
                  e +
                  "</a>"),
              (g.cache = 1e3 * (g.cache || 86400)),
              !1 === g.global_stats && (p.style.minHeight = "175px");
            var r = "gh_calendar_content",
              n = "gh_calendar_expire";
            (g.proxy =
              g.proxy ||
              function (e) {
                return fetch(
                  ...
                  return g.proxy(e).then(function (e) {
                    return (
                      g.cache &&
                        ...
                        localStorage.setItem(n, Date.now() + g.cache)),
                      e
                    );
                  });
                });
            return (function f() {
              return g
                ...
                .then(function (e) {
                  ...
                  t.innerHTML = e;
                  var r = t.querySelector(".js-yearly-contributions");
                  if (
                    (m(".position-relative h2", r).remove(),
                    (r.querySelector(".float-left.text-gray").innerHTML =
                      g.summary_text),
                    ...
                    if (!0 === g.responsive) {
                      ...
                      n.removeAttribute("height"),
                        ...
                        n.setAttribute("viewBox", "0 0 " + a + " " + o);
                    }
                    if (!1 !== g.global_stats) {
                      var s = b(m("svg", r).outerHTML),
                        u = s.current_streak
                          ? y(s.current_streak_range[0], M) +
                            " &ndash; " +
                            y(s.current_streak_range[1], M)
                          : s.last_contributed
                          ? "Last contributed in " +
                            y(s.last_contributed, M) +
                            "."
                          : "Rock - Hard Place",
                        i = s.longest_streak
                          ? y(s.longest_streak_range[0], M) +
                            " &ndash; " +
                            y(s.longest_streak_range[1], M)
                          : s.last_contributed
                          ? "Last contributed in " +
                            y(s.last_contributed, M) +
                            "."
                      ...
                      r.appendChild(c), r.appendChild(l), r.appendChild(d);
                    }
            ...
            return (
              e
                ...
                .forEach(function (e) {
                  ...
                  var t = e.match(/fill="(#[a-z0-9]+)"/),
                    r = e.match(/data-date="([0-9\-]+)"/),
                    n = e.match(/data-count="([0-9]+)"/);
                  if (((t = t && t[1]), (r = r && r[1]), (n = n && +n[1]), t)) {
                    var a = {
                      fill: t,
                      date: new Date(r),
                      count: n,
