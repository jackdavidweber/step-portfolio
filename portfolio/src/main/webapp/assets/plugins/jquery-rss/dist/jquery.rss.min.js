!(function () {
  ...
  class s {
    ...
    _appendEntries(t, e) {
      e.forEach((e, i) => {
        var s = this._wrapContent(e);
        t.insertAdjacentHTML("beforebegin", s.outerHTML);
      }),
        t.remove();
    }
    _wrapContent(t) {
    ...
    _generateHTMLForEntries() {
      ...
      return (
        this.entries.forEach((e, i) => {
          const s = this.options.offsetStart,
            n = this.options.offsetEnd;
          let o;
          s && n
            ? i >= s &&
              i <= n &&
    ...
    _getValueForToken(t, e) {
      var i = this._getTokenMap(e),
        s = i[t.replace(/[\{\}]/g, "")];
      if (void 0 !== s) return "function" == typeof s ? s(e, i) : s;
  ...
  (n = jQuery).fn.rss = function (t, e = {}, i) {
    return (
      new s(this, t, {
        ...
        fetchFeed: (t) =>
          new Promise((e, i) => {
            n.ajax({ dataType: "json", url: t, success: e, error: i });
          }),
      })
        .render()
        .then(
          (...t) => {
            i && i(...t), e && e.success && e.success(...t);
          },
          (...t) => {
            e && e.error && e.error(...t);
          }
